  ...
  function cellClick(){
    ...
    switch (next){
     ...
     break;
      ...
      catCellBackground.style.opacity = "0.65";
    ...
    switch (text){
      ...
      catCellBackground.style.opacity = "";
      quantity1Background.style.background = "#D91667";
...
switch (textFish) {
	case arrayFish[1]:
      ...
      catCellBackground_fish.style.opacity = "0.65";
...
switch (textFish) {
	case arrayFish[2]:
      ...
      catCellBackground_fish.style.opacity = "";
      quantity1Background_fish.style.background = "#D91667";
...
break;
	...
	case arrayChicken[1]:
      ...
      catCellBackground_chicken.style.opacity = "0.65";
...
case arrayChicken[2]:
      ...
      catCellBackground_chicken.style.opacity = "";
      quantity1Background_chicken.style.background = "#D91667";
